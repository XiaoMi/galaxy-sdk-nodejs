 ...
 */
var authenticationTypes = require('../lib//sds/Authentication_types');
var commonTypes = require('../lib/sds/Common_types');
var errorTypes = require('../lib/sds/Errors_types');
var tableTypes = require('../lib/sds/Table_types');
var datumUtil = require('../lib/client/datum_util');
var clientFactory = require('../lib/client/client_factory');
var tableScanner = require('../lib/client/table_scanner');
...
var cities = new Array("北京", "Beihai", "Dalian", "Dandong", "Fuzhou", "Guangzhou", "Haikou",
...
var cf = new clientFactory.ClientFactory(credential, false);
...
var mainLogic = function () {
  ...
  schema.primaryIndex = new Array(new tableTypes.KeySpec({attribute: 'cityId'}),
              ...
              tableClient.get(get, function (error, result) {
                if (error) {
                  ...
                  var scan = new tableTypes.ScanRequest({tableName: tableName,
                    attributes: new Array('cityId', 'score'), limit: 5});
