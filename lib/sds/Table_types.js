...
PartitionInfo = module.exports.PartitionInfo = function(args) {
...
PartitionInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I64) {
        this.putRequestNumber = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.I64) {
        this.deleteRequestNumber = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 3:
      if (ftype == Thrift.Type.I64) {
        this.incrementRequestNumber = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 6:
      if (ftype == Thrift.Type.I64) {
        this.fullScanNumber = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 7:
      if (ftype == Thrift.Type.I64) {
        this.compactionNumber = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
...
SubscribeInfo = module.exports.SubscribeInfo = function(args) {
...
DataConsumeRequest.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I64) {
        this.partitionId = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i365 = 0; _i365 < _size360; ++_i365)
        {
          ...
          for (var _i372 = 0; _i372 < _size367; ++_i372)
          {
            var key373 = null;
            var val374 = null;
            key373 = input.readString();
            val374 = new ttypes.Datum();
            val374.read(input);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i401 = 0; _i401 < _size396; ++_i401)
        {
          var key402 = null;
          var val403 = null;
          key402 = input.readString();
          val403 = new ttypes.Datum();
          val403.read(input);
