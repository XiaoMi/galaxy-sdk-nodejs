  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem322 = null;
          elem322 = new ttypes.BatchRequestItem();
          elem322.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem330 = null;
          elem330 = new ttypes.BatchResultItem();
          elem330.read(input);
...
GetNewImageRequest = module.exports.GetNewImageRequest = function(args) {
  this.tableName = null;
  this.partitionId = null;
  this.limit = null;
  this.offset = 0;
...
GetNewImageResult = module.exports.GetNewImageResult = function(args) {
...
GetNewImageResult.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I64) {
        this.nextStartOffset = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
