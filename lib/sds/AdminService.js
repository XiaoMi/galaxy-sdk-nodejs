...
AdminService_createSubscriber_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.Subscriber();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem154 = null;
          elem154 = new Table_ttypes.Subscriber();
          elem154.read(input);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem162 = null;
          elem162 = new Table_ttypes.Partition();
          elem162.read(input);
...
AdminService_getPartition_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.Partition();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AdminService_getPartitionConsumedOffset_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.ConsumedOffset();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AdminService_getPartitionCommittedOffset_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.CommittedOffset();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AdminService_createSinker_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.Sinker();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AdminService_getPartitionStatistics_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.PartitionStatistics();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
AdminService_getSubscriberStatistics_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new Table_ttypes.SubscriberStatistics();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem170 = null;
          elem170 = new ttypes.SnapshotTableView();
          elem170.read(input);
...
AdminServiceClient.prototype.send_createSubscriber = function(tableName, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('createSubscriber', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_createSubscriber = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('createSubscriber failed: unknown result');
};
...
AdminServiceClient.prototype.send_deleteSubscriber = function(tableName, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('deleteSubscriber', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_deleteSubscriber = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
AdminServiceClient.prototype.send_getSubscriber = function(tableName, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getSubscriber', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getSubscriber = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getSubscriber failed: unknown result');
};
...
AdminServiceClient.prototype.send_getSubscribers = function(tableName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getSubscribers', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getSubscribers = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getSubscribers failed: unknown result');
};
...
AdminServiceClient.prototype.send_getPartitions = function(tableName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPartitions', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getPartitions = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getPartitions failed: unknown result');
};
...
AdminServiceClient.prototype.send_getPartition = function(tableName, partitionId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPartition', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getPartition = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getPartition failed: unknown result');
};
...
AdminServiceClient.prototype.send_getPartitionConsumedOffset = function(tableName, partitionId, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPartitionConsumedOffset', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getPartitionConsumedOffset = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getPartitionConsumedOffset failed: unknown result');
};
...
AdminServiceClient.prototype.send_getPartitionCommittedOffset = function(tableName, partitionId, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPartitionCommittedOffset', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getPartitionCommittedOffset = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getPartitionCommittedOffset failed: unknown result');
};
...
AdminServiceClient.prototype.send_createSinker = function(subscribedTableName, subscriberName, sinkedTableName, endpoint) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('createSinker', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_createSinker = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('createSinker failed: unknown result');
};
...
AdminServiceClient.prototype.send_deleteSinker = function(tableName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('deleteSinker', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_deleteSinker = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
AdminServiceClient.prototype.send_getSinker = function(tableName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getSinker', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getSinker = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getSinker failed: unknown result');
};
...
AdminServiceClient.prototype.send_getPartitionStatistics = function(tableName, partitionId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getPartitionStatistics', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getPartitionStatistics = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getPartitionStatistics failed: unknown result');
};
...
AdminServiceClient.prototype.send_getSubscriberStatistics = function(tableName, partitionId, subscriberName) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getSubscriberStatistics', Thrift.MessageType.CALL, this.seqid());
...
AdminServiceClient.prototype.recv_getSubscriberStatistics = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getSubscriberStatistics failed: unknown result');
};
...
AdminServiceProcessor.prototype.process_createSubscriber = function(seqid, input, output) {
  var args = new AdminService_createSubscriber_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.createSubscriber.length === 2) {
    Q.fcall(this._handler.createSubscriber, args.tableName, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_createSubscriber_result({success: result});
        output.writeMessageBegin("createSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_createSubscriber_result(err);
        output.writeMessageBegin("createSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.createSubscriber(args.tableName, args.subscriberName,  function (err, result) {
      var result = new AdminService_createSubscriber_result((err != null ? err : {success: result}));
      output.writeMessageBegin("createSubscriber", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_deleteSubscriber = function(seqid, input, output) {
  var args = new AdminService_deleteSubscriber_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.deleteSubscriber.length === 2) {
    Q.fcall(this._handler.deleteSubscriber, args.tableName, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_deleteSubscriber_result({success: result});
        output.writeMessageBegin("deleteSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_deleteSubscriber_result(err);
        output.writeMessageBegin("deleteSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.deleteSubscriber(args.tableName, args.subscriberName,  function (err, result) {
      var result = new AdminService_deleteSubscriber_result((err != null ? err : {success: result}));
      output.writeMessageBegin("deleteSubscriber", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getSubscriber = function(seqid, input, output) {
  var args = new AdminService_getSubscriber_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getSubscriber.length === 2) {
    Q.fcall(this._handler.getSubscriber, args.tableName, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_getSubscriber_result({success: result});
        output.writeMessageBegin("getSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getSubscriber_result(err);
        output.writeMessageBegin("getSubscriber", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSubscriber(args.tableName, args.subscriberName,  function (err, result) {
      var result = new AdminService_getSubscriber_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSubscriber", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getSubscribers = function(seqid, input, output) {
  var args = new AdminService_getSubscribers_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getSubscribers.length === 1) {
    Q.fcall(this._handler.getSubscribers, args.tableName)
      .then(function(result) {
        var result = new AdminService_getSubscribers_result({success: result});
        output.writeMessageBegin("getSubscribers", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getSubscribers_result(err);
        output.writeMessageBegin("getSubscribers", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSubscribers(args.tableName,  function (err, result) {
      var result = new AdminService_getSubscribers_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSubscribers", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getPartitions = function(seqid, input, output) {
  var args = new AdminService_getPartitions_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPartitions.length === 1) {
    Q.fcall(this._handler.getPartitions, args.tableName)
      .then(function(result) {
        var result = new AdminService_getPartitions_result({success: result});
        output.writeMessageBegin("getPartitions", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getPartitions_result(err);
        output.writeMessageBegin("getPartitions", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPartitions(args.tableName,  function (err, result) {
      var result = new AdminService_getPartitions_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPartitions", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getPartition = function(seqid, input, output) {
  var args = new AdminService_getPartition_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPartition.length === 2) {
    Q.fcall(this._handler.getPartition, args.tableName, args.partitionId)
      .then(function(result) {
        var result = new AdminService_getPartition_result({success: result});
        output.writeMessageBegin("getPartition", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getPartition_result(err);
        output.writeMessageBegin("getPartition", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPartition(args.tableName, args.partitionId,  function (err, result) {
      var result = new AdminService_getPartition_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPartition", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getPartitionConsumedOffset = function(seqid, input, output) {
  var args = new AdminService_getPartitionConsumedOffset_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPartitionConsumedOffset.length === 3) {
    Q.fcall(this._handler.getPartitionConsumedOffset, args.tableName, args.partitionId, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_getPartitionConsumedOffset_result({success: result});
        output.writeMessageBegin("getPartitionConsumedOffset", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getPartitionConsumedOffset_result(err);
        output.writeMessageBegin("getPartitionConsumedOffset", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPartitionConsumedOffset(args.tableName, args.partitionId, args.subscriberName,  function (err, result) {
      var result = new AdminService_getPartitionConsumedOffset_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPartitionConsumedOffset", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getPartitionCommittedOffset = function(seqid, input, output) {
  var args = new AdminService_getPartitionCommittedOffset_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPartitionCommittedOffset.length === 3) {
    Q.fcall(this._handler.getPartitionCommittedOffset, args.tableName, args.partitionId, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_getPartitionCommittedOffset_result({success: result});
        output.writeMessageBegin("getPartitionCommittedOffset", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getPartitionCommittedOffset_result(err);
        output.writeMessageBegin("getPartitionCommittedOffset", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPartitionCommittedOffset(args.tableName, args.partitionId, args.subscriberName,  function (err, result) {
      var result = new AdminService_getPartitionCommittedOffset_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPartitionCommittedOffset", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_createSinker = function(seqid, input, output) {
  var args = new AdminService_createSinker_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.createSinker.length === 4) {
    Q.fcall(this._handler.createSinker, args.subscribedTableName, args.subscriberName, args.sinkedTableName, args.endpoint)
      .then(function(result) {
        var result = new AdminService_createSinker_result({success: result});
        output.writeMessageBegin("createSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_createSinker_result(err);
        output.writeMessageBegin("createSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.createSinker(args.subscribedTableName, args.subscriberName, args.sinkedTableName, args.endpoint,  function (err, result) {
      var result = new AdminService_createSinker_result((err != null ? err : {success: result}));
      output.writeMessageBegin("createSinker", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_deleteSinker = function(seqid, input, output) {
  var args = new AdminService_deleteSinker_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.deleteSinker.length === 1) {
    Q.fcall(this._handler.deleteSinker, args.tableName)
      .then(function(result) {
        var result = new AdminService_deleteSinker_result({success: result});
        output.writeMessageBegin("deleteSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_deleteSinker_result(err);
        output.writeMessageBegin("deleteSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.deleteSinker(args.tableName,  function (err, result) {
      var result = new AdminService_deleteSinker_result((err != null ? err : {success: result}));
      output.writeMessageBegin("deleteSinker", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getSinker = function(seqid, input, output) {
  var args = new AdminService_getSinker_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getSinker.length === 1) {
    Q.fcall(this._handler.getSinker, args.tableName)
      .then(function(result) {
        var result = new AdminService_getSinker_result({success: result});
        output.writeMessageBegin("getSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getSinker_result(err);
        output.writeMessageBegin("getSinker", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSinker(args.tableName,  function (err, result) {
      var result = new AdminService_getSinker_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSinker", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getPartitionStatistics = function(seqid, input, output) {
  var args = new AdminService_getPartitionStatistics_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getPartitionStatistics.length === 2) {
    Q.fcall(this._handler.getPartitionStatistics, args.tableName, args.partitionId)
      .then(function(result) {
        var result = new AdminService_getPartitionStatistics_result({success: result});
        output.writeMessageBegin("getPartitionStatistics", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getPartitionStatistics_result(err);
        output.writeMessageBegin("getPartitionStatistics", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getPartitionStatistics(args.tableName, args.partitionId,  function (err, result) {
      var result = new AdminService_getPartitionStatistics_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getPartitionStatistics", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
AdminServiceProcessor.prototype.process_getSubscriberStatistics = function(seqid, input, output) {
  var args = new AdminService_getSubscriberStatistics_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getSubscriberStatistics.length === 3) {
    Q.fcall(this._handler.getSubscriberStatistics, args.tableName, args.partitionId, args.subscriberName)
      .then(function(result) {
        var result = new AdminService_getSubscriberStatistics_result({success: result});
        output.writeMessageBegin("getSubscriberStatistics", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new AdminService_getSubscriberStatistics_result(err);
        output.writeMessageBegin("getSubscriberStatistics", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getSubscriberStatistics(args.tableName, args.partitionId, args.subscriberName,  function (err, result) {
      var result = new AdminService_getSubscriberStatistics_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getSubscriberStatistics", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
