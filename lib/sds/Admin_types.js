...
QuotaInfo = module.exports.QuotaInfo = function(args) {
  ...
  this.slaveReadCapacity = null;
  this.slaveReadCapacityUsed = null;
  this.slaveWriteCapacity = null;
  this.slaveWriteCapacityUsed = null;
  if (args) {
    ...
    if (args.slaveReadCapacity !== undefined) {
      this.slaveReadCapacity = args.slaveReadCapacity;
    }
    if (args.slaveReadCapacityUsed !== undefined) {
      this.slaveReadCapacityUsed = args.slaveReadCapacityUsed;
    }
    if (args.slaveWriteCapacity !== undefined) {
      this.slaveWriteCapacity = args.slaveWriteCapacity;
    }
    if (args.slaveWriteCapacityUsed !== undefined) {
      this.slaveWriteCapacityUsed = args.slaveWriteCapacityUsed;
    }
  }
};
QuotaInfo.prototype = {};
QuotaInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 10:
      if (ftype == Thrift.Type.I64) {
        this.slaveReadCapacity = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 11:
      if (ftype == Thrift.Type.I64) {
        this.slaveReadCapacityUsed = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 12:
      if (ftype == Thrift.Type.I64) {
        this.slaveWriteCapacity = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
      case 13:
      if (ftype == Thrift.Type.I64) {
        this.slaveWriteCapacityUsed = input.readI64();
      } else {
        input.skip(ftype);
      }
      break;
...
QuotaInfo.prototype.write = function(output) {
  ...
  if (this.slaveReadCapacity !== null && this.slaveReadCapacity !== undefined) {
    output.writeFieldBegin('slaveReadCapacity', Thrift.Type.I64, 10);
    output.writeI64(this.slaveReadCapacity);
    output.writeFieldEnd();
  }
  if (this.slaveReadCapacityUsed !== null && this.slaveReadCapacityUsed !== undefined) {
    output.writeFieldBegin('slaveReadCapacityUsed', Thrift.Type.I64, 11);
    output.writeI64(this.slaveReadCapacityUsed);
    output.writeFieldEnd();
  }
  if (this.slaveWriteCapacity !== null && this.slaveWriteCapacity !== undefined) {
    output.writeFieldBegin('slaveWriteCapacity', Thrift.Type.I64, 12);
    output.writeI64(this.slaveWriteCapacity);
    output.writeFieldEnd();
  }
  if (this.slaveWriteCapacityUsed !== null && this.slaveWriteCapacityUsed !== undefined) {
    output.writeFieldBegin('slaveWriteCapacityUsed', Thrift.Type.I64, 13);
    output.writeI64(this.slaveWriteCapacityUsed);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
