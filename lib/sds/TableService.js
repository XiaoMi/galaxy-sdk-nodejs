...
TableService_getNewImage_args.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.request = new ttypes.GetNewImageRequest();
        this.request.read(input);
      } else {
        input.skip(ftype);
      }
...
TableService_getNewImage_result.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new ttypes.GetNewImageResult();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
TableServiceClient.prototype.send_getNewImage = function(request) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getNewImage', Thrift.MessageType.CALL, this.seqid());
...
TableServiceClient.prototype.recv_getNewImage = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  return callback('getNewImage failed: unknown result');
};
...
TableServiceProcessor.prototype.process_getNewImage = function(seqid, input, output) {
  var args = new TableService_getNewImage_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getNewImage.length === 1) {
    Q.fcall(this._handler.getNewImage, args.request)
      .then(function(result) {
        var result = new TableService_getNewImage_result({success: result});
        output.writeMessageBegin("getNewImage", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new TableService_getNewImage_result(err);
        output.writeMessageBegin("getNewImage", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getNewImage(args.request,  function (err, result) {
      var result = new TableService_getNewImage_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getNewImage", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
