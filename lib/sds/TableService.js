...
TableService_batchCheckAndMutate_args = function(args) {
  this.request = null;
  if (args) {
    if (args.request !== undefined) {
      this.request = args.request;
...
TableService_batchCheckAndMutate_args.prototype = {};
TableService_batchCheckAndMutate_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
TableService_batchCheckAndMutate_args.prototype.write = function(output) {
  output.writeStructBegin('TableService_batchCheckAndMutate_args');
  if (this.request !== null && this.request !== undefined) {
    output.writeFieldBegin('request', Thrift.Type.STRUCT, 1);
    this.request.write(output);
    output.writeFieldEnd();
...
TableService_batchCheckAndMutate_result = function(args) {
  this.success = null;
  this.se = null;
  if (args instanceof Errors_ttypes.ServiceException) {
    this.se = args;
...
TableService_batchCheckAndMutate_result.prototype = {};
TableService_batchCheckAndMutate_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
TableService_batchCheckAndMutate_result.prototype.write = function(output) {
  output.writeStructBegin('TableService_batchCheckAndMutate_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
TableServiceClient.prototype.batchCheckAndMutate = function(request, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
TableServiceClient.prototype.send_batchCheckAndMutate = function(request) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('batchCheckAndMutate', Thrift.MessageType.CALL, this.seqid());
  var args = new TableService_batchCheckAndMutate_args();
  args.request = request;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
TableServiceClient.prototype.recv_batchCheckAndMutate = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new TableService_batchCheckAndMutate_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('batchCheckAndMutate failed: unknown result');
};
...
TableServiceProcessor.prototype.process_batchCheckAndMutate = function(seqid, input, output) {
  var args = new TableService_batchCheckAndMutate_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.batchCheckAndMutate.length === 1) {
    Q.fcall(this._handler.batchCheckAndMutate, args.request)
      .then(function(result) {
        var result = new TableService_batchCheckAndMutate_result({success: result});
        output.writeMessageBegin("batchCheckAndMutate", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new TableService_batchCheckAndMutate_result(err);
        output.writeMessageBegin("batchCheckAndMutate", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.batchCheckAndMutate(args.request,  function (err, result) {
      var result = new TableService_batchCheckAndMutate_result((err != null ? err : {success: result}));
      output.writeMessageBegin("batchCheckAndMutate", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
